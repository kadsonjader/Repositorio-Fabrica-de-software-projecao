...
require_once('../../model/dao/UsuarioDAO.php');
	...
	if(!isset($_GET['pg'])){
		...
		if($_GET['pg'] == 'arquivo' || $_GET['pg'] == 'cursoarquivo' || $_GET['pg'] == 'verarquivo'){
	...
	$usuLogado = $loginDAO -> buscarPorMatricula($_SESSION['aluno']);
?>
<!doctype html>
<html lang="pt-br">
<head>
...
<div class="wrapper">
    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
                <a href="../aluno/" class="simple-text">
                    Repositório
                </a>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                           <a href="">
                               <?php echo $usuLogado -> getNome_completo(); ?>
                            </a>
                        </li>
                        <!--li class="dropdown">
                              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
